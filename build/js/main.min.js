...
/* harmony import */ var _modules_page_scroll_to_advice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/page-scroll-to-advice */ "./js/modules/page-scroll-to-advice.js");
/* harmony import */ var _modules_company_description__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/company-description */ "./js/modules/company-description.js");
/* harmony import */ var _modules_page_footer_accordeon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/page-footer-accordeon */ "./js/modules/page-footer-accordeon.js");
...
/* harmony import */ var _modules_modals_modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modals/modal */ "./js/modules/modals/modal.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_page_scroll_to_advice__WEBPACK_IMPORTED_MODULE_2__["scrollToAdvice"])();
  Object(_modules_company_description__WEBPACK_IMPORTED_MODULE_3__["toggleDescription"])();
  Object(_modules_page_footer_accordeon__WEBPACK_IMPORTED_MODULE_4__["toggleAccordeon"])();
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_mask__WEBPACK_IMPORTED_MODULE_5__["initPhoneMask"])();
    Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_6__["validateForm"])();
    Object(_modules_modals_modal__WEBPACK_IMPORTED_MODULE_7__["openModal"])();
    Object(_modules_modals_modal__WEBPACK_IMPORTED_MODULE_7__["closeModal"])();
  });
});
...
/***/ "./js/modules/company-description.js":
/*!*******************************************!*\
  !*** ./js/modules/company-description.js ***!
  \*******************************************/
/*! exports provided: toggleDescription */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleDescription", function() { return toggleDescription; });
var companyDescription = document.querySelector('[data-company]');
var descriptionToggle = document.querySelector('[data-company-button]');
var toggleDescription = function toggleDescription() {
  companyDescription.setAttribute('data-company', 'is-closed');
  descriptionToggle.addEventListener('click', function () {
    var value = companyDescription.getAttribute('data-company');
    if (value === 'is-closed') {
...
var userName = modalContainer.querySelector('[name="modal-user-name"]');
var userPhone = modalContainer.querySelector('[name="modal-user-phone"]');
...
var prepareToCloseModal = function prepareToCloseModal() {
  toggleModal();
...
/***/ "./js/modules/page-footer-accordeon.js":
/*!*********************************************!*\
  !*** ./js/modules/page-footer-accordeon.js ***!
  \*********************************************/
/*! exports provided: toggleAccordeon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleAccordeon", function() { return toggleAccordeon; });
var siteSections = document.querySelector('[data-site-sections]');
var siteSectionsToggle = siteSections.querySelector('[data-site-sections-toggle]');
var contacts = document.querySelector('[data-contacts]');
var contactsToggle = contacts.querySelector('[data-contacts-toggle]');
var toggleAccordeon = function toggleAccordeon() {
  ...
  siteSectionsToggle.addEventListener('click', function () {
    var value = siteSections.getAttribute('data-site-sections');
    if (value === 'is-closed') {
  ...
  contactsToggle.addEventListener('click', function () {
    var value = contacts.getAttribute('data-contacts');
    if (value === 'is-closed') {
      contacts.setAttribute('data-contacts', 'is-opened');
      siteSections.setAttribute('data-site-sections', 'is-closed');
    }
...
/***/ "./js/modules/page-scroll-to-advice.js":
/*!*********************************************!*\
  !*** ./js/modules/page-scroll-to-advice.js ***!
  \*********************************************/
/*! exports provided: scrollToAdvice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToAdvice", function() { return scrollToAdvice; });
var promoButton = document.querySelector('[data-promo-button]');
var adviceSection = document.querySelector('[data-advice]');
var scrollToAdvice = function scrollToAdvice() {
